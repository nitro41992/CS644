...
public class RelFrequency {
	...
	public static class Map extends Mapper<LongWritable, Text, Text, LongWritable> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			// Converts all characters to lower case and uses regex to remove special
	...
	public static class Combiner extends Reducer<Text, LongWritable, Text, LongWritable> {
		...
		public void reduce(Text key, Iterable<LongWritable> values, Context context)
			...
			// Loops through all frequencies based on the matching keys, sums frequency
			// values and passes combined frequencies to the reducer
	...
	public static void main(String[] args) throws Exception {
		...
		// Obtain and output time after completion of mapreduce process
